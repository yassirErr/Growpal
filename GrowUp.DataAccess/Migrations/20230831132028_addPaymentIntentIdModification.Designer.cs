...
namespace GrowUp.DataAccess.Migrations
{
    ...
    [Migration("20230831132028_addPaymentIntentIdModification")]
    partial class addPaymentIntentIdModification
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GrowUp.Model.Contact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GrowUp.Model.OrderDetail", b =>
                {
                    ...
                    b.Property<int>("PayMonthlyPlanId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GrowUp.Model.OrderDetail", b =>
                {
                    b.HasOne("GrowUp.Model.OrderHeader", "OrderHeader")
                        .WithMany()
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GrowUp.Model.PayMonthlyPlan", "PayMonthlyPlan")
                        .WithMany()
                        .HasForeignKey("PayMonthlyPlanId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("OrderHeader");

                    b.Navigation("PayMonthlyPlan");
                });
